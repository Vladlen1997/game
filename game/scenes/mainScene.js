export default class mainScene extends Phaser.Scene {
    ...
    create(){
        ...
        this.bishop = this.physics.add.sprite(100, 100, 'bishop');
    ...
    update(){
        if(this.cursor.left.isDown){
            ...
            this.bishop.setVelocityX(0)
        }

        if(this.cursor.up.isDown && this.bishop.body.touching.down) {
            this.bishop.setVelocityY(-330)
        }
    }
